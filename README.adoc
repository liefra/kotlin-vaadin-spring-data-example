...
The `complete` example has been converted to Kotlin and uses Karibu-DSL for UI creation. You can quickly browse to [VaadinUI.kt](complete/src/main/java/hello/VaadinUI.kt) to see the Kotlin in action.
